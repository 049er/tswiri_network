...
class QRCodeDetectorPainter extends CustomPainter {
  QRCodeDetectorPainter(
    this.barcodes,
  ...
  void paint(Canvas canvas, Size size) {
    ...
    for (final Barcode barcode in barcodes) {
      if (isValidRawValue(barcode.rawValue)) {
  ...
  @override
  bool shouldRepaint(QRCodeDetectorPainter oldDelegate) {
